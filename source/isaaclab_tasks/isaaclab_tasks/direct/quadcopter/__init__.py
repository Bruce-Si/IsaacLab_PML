...
gym.register(
    id="Isaac-Quadcopter-RGBD-Obstacle-Avoidance-v1",
    entry_point=f"{__name__}.rgbd_obstacle_avoidance_env_v1:RgbdObstacleAvoidanceEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rgbd_obstacle_avoidance_env_v1:RgbdObstacleAvoidanceEnvCfg",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_rgbd_obs_avoid_cfg:QuadcopterPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_rgbd_obs_avoid_cfg.yaml",
    },
)
...
gym.register(
    ...
    kwargs={
        ...
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_lidar_obs_avoid_cfg.yaml",
    },
)
