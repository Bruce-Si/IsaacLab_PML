...
class RgbdObstacleAvoidanceEnvCfgWindow(BaseEnvWindow):
    """Window manager for the Quadcopter environment."""

    def __init__(self, env: RgbdObstacleAvoidanceEnvCfg, window_name: str = "IsaacLab"):
...
class RgbdObstacleAvoidanceEnvCfg(DirectRLEnvCfg):
    ...
    ui_window_class_type = RgbdObstacleAvoidanceEnvCfgWindow
...
class RgbdObstacleAvoidanceEnvCfg_PLAY(RgbdObstacleAvoidanceEnvCfg):
